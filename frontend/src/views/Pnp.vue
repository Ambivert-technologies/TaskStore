      ...
      <ul class="list-group">
        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
          <div class="d-flex flex-column">
            <!-- <h6 class="text-sm">Read</h6> -->
            <!-- <div class="ms-auto text-end">
              <a class="btn btn-link text-dark px-3 mt-0" href="#" v-if="role == 'admin'">
                <i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit
              </a>
            </div> -->
            Task Store built the Script Automator app as a Freemium app. This SERVICE is provided by Task Store at no cost and is intended for use as is.
            <br>
            This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service.
            If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.
            <br>
            The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at Script Automator unless otherwise defined in this Privacy Policy.
            <h6 class="mt-3 text-sm">Information Collection and Use</h6>
            ...
            <br>
            <h6 class="mt-3 text-sm">Changes to This Privacy Policy</h6>
            We may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page.
            <br>
            This policy is effective as of 2022-02-14
            <br>
            <h6 class="mt-3 text-sm">Contact Us</h6>
            If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at hello@taskstore.in
          </div>
        </li>
      </ul>
    </div>
